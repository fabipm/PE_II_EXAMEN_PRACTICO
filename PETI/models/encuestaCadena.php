...
class EncuestaCadena {
    private $id_encuesta_cadena;
    private $p1;
    private $p2;
    private $p3;
    private $p4;
    ...
    // Getters
    public function getIdEncuestaCadena() {
        return $this->id_encuesta_cadena;
    }
    ...
    public function getReflexion() { return $this->reflexion; }
    public function getIdUsuario() { return $this->id_usuario; }

    // Setters
    public function setIdEncuestaCadena($id) {
        $this->id_encuesta_cadena = intval($id);
        return $this;
    }
    ...
    public function setReflexion($reflexion) {
        $this->reflexion = $this->db->real_escape_string(trim($reflexion));
        return $this;
    }
    ...
    public function guardar() {
        $sql = "INSERT INTO encuesta_cadena VALUES(
            NULL, 
            {$this->getP1()}, 
            {$this->getP2()}, 
            {$this->getP3()}, 
        ...
        if ($guardado) {
            $this->id_encuesta_cadena = $this->db->insert_id;
            return true;
        }
        return false;
    }
    ...
    public function obtenerPorUsuario($id_usuario) {
        $sql = "SELECT * FROM encuesta_cadena 
                ...
                ORDER BY id_encuesta_cadena DESC";
